...
### ImageJ 1.54f, Java 1.8.0_322 (64-bit)
### TrackMate v7.9.2
...
#	imp.show()
	...
	for id in model.getTrackModel().trackIDs(True):
	    ...
	    for spot in track:
	        ...
	        x=spot.getFeature('POSITION_X')*(1/image_scale)
	        y=spot.getFeature('POSITION_Y')*(1/image_scale)
	        z=spot.getFeature('POSITION_Z')*(1/image_scale)
