...
soi = ['Cell_Volume','Cell_SurfaceArea','Cell_Aspect_Ratio']#,'directional_autocorrelation']
ylabels = ['Cell Volume (µm$^3$)','Cell Surface Area (µm$^2$)', 'Cell Aspect Ratio']#, 'Directional Autocorrelation']
scale = len(soi)
linewid = 2
