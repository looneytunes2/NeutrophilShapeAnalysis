...
meshdir = Path('C:/Users/Aaron/NeutrophilShapeAnalysis/data/trajectory_confocal/shape_data/PC_Meshes/') #'E:/Aaron/Combined_37C_Confocal_PCA_planar/Data_and_Figs/PC_Meshes/'
...
perspectives = ['xy','xy','xz','xz','yz','xy','xz','xy']#,'xy','xy']
