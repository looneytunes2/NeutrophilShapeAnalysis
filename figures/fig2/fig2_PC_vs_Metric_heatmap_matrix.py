...
metrics =  [['Cell_Volume','Cell_SurfaceArea','Volume_Front_Ratio','Volume_Right_Ratio','Volume_Top_Ratio','Cell_Sphericity'],
            ...
            ['speed','Turn_Angle']#'directional_autocorrelation',
            ]
...
labelz = [['Cell Volume (µm$^3$)','Cell Surface Area (µm$^2$)','Front-Back Volume Ratio','Right-Left Volume Ratio','Top-Bottom Volume Ratio','Cell Sphericity'],
          ...
          ['Instantaneous Speed (µm/sec)','Turn Angle (°)']#,'Directional Autocorrelation',
          ]
#get PCs in order
...
cbar_ax = fig.add_axes([0.92, 0.115, 0.015, 0.76])  # [left, bottom, width, height]
