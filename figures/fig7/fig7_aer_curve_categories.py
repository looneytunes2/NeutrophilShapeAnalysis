...
derivframe = derivframe.merge(df[df.lag_min==4*time_interval/60][['cell','dot_prod']], on = 'cell', how = 'left')
...
includelist = ['speed', 'directional_autocorrelation','dot_prod','aer_state']
...
ylabels = ['Cell Volume (µm$^3$)','Front-Rear Volume Ratio','Cell Surface Area (µm$^2$)','Cell Sphericity',
