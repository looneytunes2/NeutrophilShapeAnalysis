...
basedir = 'E:/Aaron/Galvanotaxis_Confocal_40x_37C_10s_smooth/'
...
# save animation
SaveAnimation(__file__.split('.')[0]+'.mp4', view, ImageResolution=[1000, 1000], FrameRate=10)#, ImageResolution=[788, 364])
